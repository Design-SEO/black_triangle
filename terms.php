...
<html lang="<?php echo getLang('locale_lang') ?>">
    ...
    <head>
        ...
        <link href="/assets/css/terms.css" media="all" rel="stylesheet" />
    ...
    <body
        class="page-template-default page page-id-48 wp-custom-logo wp-embed-responsive slideout-enabled slideout-mobile sticky-menu-fade no-sidebar nav-float-right one-container header-aligned-left dropdown-hover full-width-content"
            ...
            <div class="site-content" id="content">
                <div class="content-area" id="primary">
                    <main class="site-main" id="main">
                        <article class="post-48 page type-page status-publish" id="post-48" itemscope="" itemtype="https://schema.org/CreativeWork">
                            <div class="inside-article">
                                <div class="entry-content" itemprop="text">
                                    <div class="gb-container gb-container-286e92f5">
                                        <div class="gb-container gb-container-3eba5df1">
                                            <h1 class="gb-headline gb-headline-fb43c38b gb-headline-text">
                                                <?php echo getLang('terms') ?>
                                            </h1>
                                        </div>
                                    </div>
                                    <div class="gb-container gb-container-427f5572">
