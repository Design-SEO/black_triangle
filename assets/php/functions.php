...
{
    $lang = getLangFromFolder();
    $site_url = 'https://floventra.org';
    $site_name = 'Floventra';
    $author_name = 'Floventra Team';
    ...
    $jsonLd1 = [
        ...
        'review' => [
            ...
            'reviewBody' => getLang('jsonld_organization_review_body') ?: 'Floventra provides an investing platform with intelligent tools, flexible portfolios, and clear reporting to help clients in London manage and grow their money with confidence.',
            'reviewRating' => [
                '@type' => 'Rating',
            ...
            'author' => [
                '@type' => 'Person',
                'name' => getLang('jsonld_organization_review_author') ?: 'Floventra User',
            ],
            'publisher' => [
                '@type' => 'Organization',
                'name' => getLang('jsonld_organization_name'),
    ...
    $jsonLd4 = [
        ...
        'keywords' => getLang($keywords_key) ?: 'about Floventra, investing platform, AI investments London',
    ];
    ...
    if ($page === 'index') {
        ...
        $jsonLd7 = [
            ...
            'name' => getLang('jsonld_financialservice_name') ?: 'Floventra Investment Services',
            'description' => getLang('jsonld_financialservice_description') ?: 'Floventra offers secure cryptocurrency investing services starting from £182, with intelligent tools, flexible portfolios, and FCA-compliant support for UK investors in London and beyond.',
